...
export default class PreferenceScreen extends Component {
  ...
  render() {
   ...
   // Inside the render method
    ...
    const menuDetails = menuDetailedData[index];

    // Check if menuDetails is defined
    if (menuDetails) {
        const { meal, details, price } = menuDetails;
        return (
        <View style={styles.container} >
            <ScrollView>
                <View style ={styles.header}>
                    <Image
                        ...
                        source ={{uri:"https://www.netnewsledger.com/wp-content/uploads/2015/12/big_mac.jpg"}}
                    />
                </View>
                ...
                <View style={styles.view4} >
                    <View style={styles.view5} >
                        ...
                        <Text style={styles.text6} > ${price !== undefined ? price.toFixed(2) : ""} </Text>
                    </View>
                </View>
                <View>
                            ...
                            >
                                <View style={styles.view4} >
                                    <View style={styles.view19} >
                                        ...
                                        <Text style={styles.text6} > ${items.price !== undefined ? items.price.toFixed(2) : ""} </Text>
                                    </View>
                                </View>
                            </TouchableOpacity>
                            )}
            ...
            <View style={styles.view17} >
                <View style={styles.view18} >
                    <Text style={styles.text10} > Add 1 to Cart $70.20 </Text>
                </View>
            </View>
        </View>
        );
    } else {
        // Handle the case where menuDetails is undefined
        return (
          <View style={styles.container}>
            <Text>Loading...</Text>
          </View>
