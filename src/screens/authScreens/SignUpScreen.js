        ...
        <ScrollView keyboardShouldPersistTaps='always' >
                    ...
                    <View style={styles.view2} >
                        ...
                        <View style={styles.view14} >
                            <Animatable.View animation={passwordFocussed?"":"fadeInLeft"} duration={400} >
                                <Icon name='lock' type= 'material' style={{fontSize:20,paddingRight:10,color: colors.grey3}}/>
                            </Animatable.View>
                            <TextInput
                            ...
                            <Animatable.View animation={passwordBlured?"":"fadeInLeft"} duration={400} >
                                <Icon name='visibility-off' type= 'material-community' style={{fontSize:20, marginRight:10,color: colors.grey3}} />
                            </Animatable.View>
                        </View>
            ...
            <View style ={styles.view19}>
                <View style ={styles.view20}>
                    <Text style ={styles.text2}>Already have an account with XpressFood ?</Text>
                </View>
                <View style ={styles.view21}>
                    <Button 
                        ...
                        onPress ={()=>{if(navigation){navigation.navigate('SignInScreen')}}}
                    />
                </View>
            </View>
